...
This dataset provides calculated account-level output for the Card Small Business Financial Exchange reporting workflow. The source data comes from the Card Enterprise Credit Bureau Reporting consolidated input, which combines upstream Card account, customer, payment, delinquency, credit limit, charge-off, recovery, and suppression information used for bureau reporting. Enterprise Credit Bureau Reporting, data quality, operations, compliance, and audit teams use this dataset to validate account eligibility, calculated reporting fields, reporting accuracy, traceability, and audit readiness. It is maintained separately from temporary ingestion datasets and other credit reporting datasets because it supports the specific Card Small Business Financial Exchange submission process.
