...
def test_get_current_credit_limit(spark: SparkSession):
    input_df = create_partially_filled_dataset(
        ...
        CCAccount,
        data=[
            {CCAccount.account_id.str: "A1", CCAccount.available_spending_amount.str: 999.49},
    ...
    expected_df = create_partially_filled_dataset(
        ...
        ABSegment,
        data=[
            {ABSegment.account_id.str: "A1", ABSegment.current_credit_limit.str: 999},
            {ABSegment.account_id.str: "A2", ABSegment.current_credit_limit.str: None},
        ],
...
def test_get_original_credit_limit(spark: SparkSession):
    input_df = create_partially_filled_dataset(
        ...
        CCAccount,
        data=[
            {CCAccount.account_id.str: "A1", CCAccount.available_spending_amount.str: 500.6},
            {CCAccount.account_id.str: "A2", CCAccount.available_spending_amount.str: None},
        ],
    )
    ...
    expected_df = create_partially_filled_dataset(
        ...
        ABSegment,
        data=[
            {ABSegment.account_id.str: "A1", ABSegment.original_credit_limit.str: 501},
            {ABSegment.account_id.str: "A2", ABSegment.original_credit_limit.str: None},
        ],
