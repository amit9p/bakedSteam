...
# Drop ambiguous columns from the join
df2_with_ssn = df2_with_ssn.drop("df1_ssn.attribute").drop("df1_ssn.tokenization_type").drop("df1_ssn.ssn_value")
...
# Drop ambiguous columns from the join
df2_final = df2_final.drop("df1_pan.attribute").drop("df1_pan.tokenization_type").drop("df1_pan.pan_value")
