This dataset provides calculated account-level output for the Card Small Business Financial Exchange reporting workflow. The source data comes from the Card Enterprise Credit Bureau Reporting consolidated input, which combines upstream Card account, customer, payment, delinquency, credit limit, charge-off, recovery, and suppression details. Data quality, operations, compliance, and audit teams use this dataset to validate reporting accuracy, traceability, account eligibility, and audit readiness. This dataset is maintained separately from temporary ingestion datasets because it supports the specific Card small business bureau reporting process.
